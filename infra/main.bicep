...
param virtualNetworks_vnet_veterinaria_dev_name string = 'vnet-veterinaria-dev'
param storageAccounts_stveterinariadev2026_name string = 'stveterinariadev2026'
param networkInterfaces_vm_veterinaria_dev295_name string = 'vm-veterinaria-dev295'
...
resource networkSecurityGroups_vm_veterinaria_dev_nsg_name_resource 'Microsoft.Network/networkSecurityGroups@2025-05-01' = {
  ...
  properties: {
    securityRules: [
      ...
      {
        name: 'Tomcat-8080'
        id: networkSecurityGroups_vm_veterinaria_dev_nsg_name_Tomcat_8080.id
        properties: {
          protocol: 'TCP'
          sourcePortRange: '*'
...
resource virtualNetworks_vnet_veterinaria_dev_name_resource 'Microsoft.Network/virtualNetworks@2025-05-01' = {
  name: virtualNetworks_vnet_veterinaria_dev_name
  location: 'chilecentral'
  properties: {
    addressSpace: {
      addressPrefixes: [
    ...
    subnets: [
      {
        name: 'subnet-app'
        id: virtualNetworks_vnet_veterinaria_dev_name_subnet_app.id
        properties: {
...
resource virtualMachines_vm_veterinaria_dev_name_resource 'Microsoft.Compute/virtualMachines@2025-11-01' = {
  ...
  properties: {
    ...
    storageProfile: {
      ...
      osDisk: {
        osType: 'Linux'
        name: '${virtualMachines_vm_veterinaria_dev_name}_disk1_1bd7d410fe244c3081b5e7d78b7ce411'
        ...
        managedDisk: {
          ...
          id: resourceId(
            ...
            '${virtualMachines_vm_veterinaria_dev_name}_disk1_1bd7d410fe244c3081b5e7d78b7ce411'
          )
        }
        deleteOption: 'Delete'
        diskSizeGB: 30
    ...
    networkProfile: {
      networkInterfaces: [
        {
          id: networkInterfaces_vm_veterinaria_dev295_name_resource.id
          properties: {
            deleteOption: 'Detach'
          }
        }
...
resource flexibleServers_mysql_veterinaria_dev_name_general_log_file 'Microsoft.DBforMySQL/flexibleServers/configurations@2025-06-01-preview' = {
  ...
  properties: {
    value: '/app/work2/serverlogs/mysql-general-mysql-veterinaria-dev-2026070617.log'
    currentValue: '/app/work2/serverlogs/mysql-general-mysql-veterinaria-dev-2026070617.log'
    source: 'user-override'
  }
}
...
resource flexibleServers_mysql_veterinaria_dev_name_slow_query_log_file 'Microsoft.DBforMySQL/flexibleServers/configurations@2025-06-01-preview' = {
  ...
  properties: {
    value: '/app/serverlogs/slowlogs/mysql-slow-mysql-veterinaria-dev-2026070617.log'
    currentValue: '/app/serverlogs/slowlogs/mysql-slow-mysql-veterinaria-dev-2026070617.log'
    source: 'user-override'
  }
}
...
resource flexibleServers_mysql_veterinaria_dev_name_ClientIPAddress_2026_7_6_12_8_10 'Microsoft.DBforMySQL/flexibleServers/firewallRules@2025-06-01-preview' = {
  parent: flexibleServers_mysql_veterinaria_dev_name_resource
  name: 'ClientIPAddress_2026-7-6_12-8-10'
  properties: {
    startIpAddress: '38.25.29.19'
    endIpAddress: '38.25.29.19'
  }
}
...
resource networkSecurityGroups_vm_veterinaria_dev_nsg_name_Tomcat_8080 'Microsoft.Network/networkSecurityGroups/securityRules@2025-05-01' = {
  name: '${networkSecurityGroups_vm_veterinaria_dev_nsg_name}/Tomcat-8080'
  properties: {
    protocol: 'TCP'
    sourcePortRange: '*'
    destinationPortRange: '8080'
...
resource virtualNetworks_vnet_veterinaria_dev_name_subnet_app 'Microsoft.Network/virtualNetworks/subnets@2025-05-01' = {
  name: '${virtualNetworks_vnet_veterinaria_dev_name}/subnet-app'
  properties: {
    addressPrefix: '10.0.0.0/24'
    delegations: []
    privateEndpointNetworkPolicies: 'Disabled'
  ...
  dependsOn: [
    virtualNetworks_vnet_veterinaria_dev_name_resource
  ]
}
...
resource networkInterfaces_vm_veterinaria_dev295_name_resource 'Microsoft.Network/networkInterfaces@2025-05-01' = {
  name: networkInterfaces_vm_veterinaria_dev295_name
  location: 'chilecentral'
  kind: 'Regular'
  properties: {
    ipConfigurations: [
      {
        name: 'ipconfig1'
        id: '${networkInterfaces_vm_veterinaria_dev295_name_resource.id}/ipConfigurations/ipconfig1'
        properties: {
