...
<html lang="es">
    <head>
        ...
        <style>
            ...
            body.modo-noche .historial-container {
                background-color: #020617;
                box-shadow: 0 12px 32px rgba(0,0,0,0.7);
            }
            body.modo-noche .historial-container h2 {
                color: #4ade80;
                text-shadow: none;
            }
            ...
            body.modo-noche thead {
                background: #111827;
            }
            body.modo-noche tbody tr:nth-child(even) {
                background-color: #030712;
            }
            body.modo-noche tbody tr:hover {
                background-color: #111827;
            }

            body.modo-noche td[colspan="3"] {
                color: #e5e7eb;
            }

            /* Botones */
            body.modo-noche .btn-confirmar {
            ...
            body.modo-noche .modal-header {
                color: #4ade80;
            }
            body.modo-noche .modal p {
                color: #e5e7eb;
            }
            body.modo-noche .modal select {
                background-color: #111827;
                color: #e5e7eb;
                border-color: #374151;
            }

            /* Inputs dinámicos del pago tarjeta */
            body.modo-noche #pagoExtra input {
                background-color: #111827;
                color: #e5e7eb;
                border-color: #374151;
            }
    ...
    <body>
        ...
        <!-- Botón flotante modo noche -->
        <button id="modoNocheBtn" class="modo-noche-flotante" aria-label="Cambiar modo noche">🌙</button>

        <!-- JS de modo noche global -->
