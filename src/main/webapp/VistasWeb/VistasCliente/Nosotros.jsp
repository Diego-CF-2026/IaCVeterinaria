...
<html lang="es">
    <head>
        ...
        <style>
            ...
            /* Cuadros de contenido (tarjetas) en modo noche */
            body.modo-noche .cuadro-nosotros {
                background-color: #202124;   /* tapa el celeste de nosotros.css */
                box-shadow: 0 12px 32px rgba(0,0,0,0.7);
            }

            body.modo-noche .descripcion h2 {
                color: #f9fafb;
            }

            body.modo-noche .descripcion p {
                color: #e5e7eb;
            }
            ...
            /* Botón flotante en modo noche (oscuro con sol dorado) */
    ...
    <body>
        ...
        <!-- JS de modo noche (usa el que ya tienes hecho; ajusta la ruta si es distinta) -->
