...
public class ReporteEmpleadosServlet extends HttpServlet {
        ...
        try (OutputStream os = response.getOutputStream()) {
            ...
            if (listaVeterinarios != null && !listaVeterinarios.isEmpty()) {
                ...
                for (Veterinario vet : listaVeterinarios) {
                    ...
                    addCell(tablaVeterinarios, vet.getNombreVeterinario(), fontContenido);
                    addCell(tablaVeterinarios, vet.getApellidoVeterinario(), fontContenido);  
                    addCell(tablaVeterinarios, vet.getTelefonoVeterinario(), fontContenido);
                    addCell(tablaVeterinarios, String.valueOf(vet.getIdEspecialidad()), fontContenido);
                }
    ...
    private void addTableHeader(PdfPTable table, Font font, String[] headers) {
        for (String header : headers) {
            ...
            cell.setBackgroundColor(new BaseColor(60, 100, 200)); 
